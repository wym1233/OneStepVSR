...
from model.S3diff.animatediffmodels.unet_blocks import (
...
from model.S3diff.animatediffmodels.resnet import InflatedConv3d, InflatedGroupNorm
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    @classmethod
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None, unet_additional_kwargs={}):
        ...
        # Print main parameter names from the model
        ...
        # print("=== Model main parameter names ===")
        # last_prefix = None
        # for name, _ in model.named_parameters():
        #     if not name.startswith("motion_modules"): # Skip motion module params
        #         parts = name.split('.')
        #         prefix = '.'.join(parts[:3])
        ...
        # print("\n=== State dict main parameter names ===")
        # last_prefix = None 
        ...
        print('load SDTurbo unet base para')
