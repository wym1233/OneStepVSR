...
def parse_args_paired_testing(input_args=None):
   ...
   """
    ...
    parser.add_argument("--ref_path", type=str, default='/data/wym123/VSRdataset/REDS/REDS4/train_sharp',)
    ...
    # training details
    parser.add_argument("--output_dir", type=str, default='/data/wym123/VSRdataset/inference_out/S3diff')
    ...
    def __init__(self, opt):
        ...
        with open(opt['meta_info_file'], 'r') as fin:
            for line in fin:
                ...
                self.lr_paths.extend([opt['lr_path']+f'{folder}/{i:08d}'+'.png' for i in range(int(frame_num))])
