...
from model.stableVSR.stablevsrpipeline import StableVSRPipeline
...
parser.add_argument("--out_path", default='/data/wym123/VSRdataset/newinference_out3/stableVSR_REDS30', type=str, help="Path to output folder.")
...
model_id = '/data/wym123/VSRdataset/stableVSR'
...
# python /code/trains3diff/stableVSR_test.py --in_path /data/wym123/VSRdataset/REDS/REDS4/train_sharp_bicubic/X4 --out_path /data/wym123/VSRdataset/newinference_out4/stableVSR_REDS4